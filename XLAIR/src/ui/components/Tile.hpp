...
namespace ui::components {
    ...
    public:
        ...
        const MSRenderTexture& get(const core::types::SheetMetadata& data, const TextureRegion& jacket, int8 difficulty_index, const core::types::Record& record, const double offset = 0.0) const;
    ...
    private:
        ...
        void drawMetadataSection(const core::types::SheetMetadata& data, StringView designer, const core::types::Record& record, double offset, const ui::theme::DifficultyTheme& theme) const;
