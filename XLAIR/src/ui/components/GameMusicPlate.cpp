...
namespace ui::components {
    void DrawGameMusicPlate(const Point& pos, const core::types::SheetMetadata& data, const TextureRegion& jacket, int8 difficulty_index, const double offset, int32 max_playable, int32 left_playable_music) {
        ...
        for (const auto i : step(max_playable)) {
