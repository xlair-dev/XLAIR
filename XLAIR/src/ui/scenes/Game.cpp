...
namespace ui {
    ...
    void Game::drawField() const {
...

        {
            ...
            FontAsset(app::assets::font::UiComboNumber)(U"279").drawAt(center_x, h - 750, theme::Palette::White);
            ...
            RectF{ Arg::leftCenter(0, judge_y), w, 5.0 }.drawShadow(Vec2{ 0.0, 10.0 }, 30.0, 0.0, JudgeColor.withA(0.15)).draw(JudgeColor);
