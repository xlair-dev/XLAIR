...
set(SIV3D_PROJECT_RESOURCES_PATH "${PROJECT_SOURCE_DIR}/resources")
set(SIV3D_SDK_CACHE_DIR
    "${PROJECT_SOURCE_DIR}/.cache/siv3d/${SIV3D_VERSION}"
...
include("${SIV3D_CMAKE_DIR}/Archive.cmake")
...
function(siv3d_resources target)
    ...
    foreach(platform_index RANGE 0 ${last_index} 3)
        ...
        get_target_property(target_resources_path "${target}" SIV3D_PROJECT_RESOURCES_DIR)
        if(NOT target_resources_path)
            set(target_resources_path "${SIV3D_PROJECT_RESOURCES_PATH}")
        endif()

        if(EXISTS "${target_resources_path}/${arg_path}")
            set(arg_path_root "${target_resources_path}")
